...
-- rule= rule -> rule-name-opt > symbol ARROW symbol-seq-opt >
addRule (Name('rule', nil, true), Symbol('rule'), {Symbol('rule-name-opt', nil, nil, nil, Priority(1)), Symbol('symbol'), Symbol('ARROW'), Symbol('symbol-seq-opt', nil, nil, nil, Priority(1))})
...
-- attrib_seq_5 = attrib-seq -> attrib-seq PLUS bang-seq-opt
addRule (Name('attrib-seq-5', nil, true), Symbol('attrib-seq'), {Symbol('attrib-seq'), Symbol ('PLUS'), Symbol('bang-seq-opt')})
-- attrib_seq_6 = attrib-seq -> attrib-seq CARET bang-seq-opt
addRule (Name('attrib-seq-6', nil, true), Symbol('attrib-seq'), {Symbol('attrib-seq'), Symbol('CARET'), Symbol('bang-seq-opt')})
-- attrib_seq_7 = attrib-seq -> attrib-seq GT bang-seq-opt
addRule (Name('attrib-seq-7', nil, true), Symbol('attrib-seq'), {Symbol('attrib-seq'), Symbol('GT'), Symbol('bang-seq-opt')})
